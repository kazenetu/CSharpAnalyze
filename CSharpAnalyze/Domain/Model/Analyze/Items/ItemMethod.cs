...
namespace CSharpAnalyze.Domain.Model.Analyze.Items
{
  ...
  /// アイテム：メソッド
  /// </summary>
  internal class ItemMethod : AbstractItem, IItemMethod
  {
    /// <summary>
    /// メソッドの型リスト
    /// </summary>
    ...
    public ItemMethod(MethodDeclarationSyntax node, SemanticModel semanticModel, IAnalyzeItem parent, EventContainer container) : base(parent, node, semanticModel, container)
    {
