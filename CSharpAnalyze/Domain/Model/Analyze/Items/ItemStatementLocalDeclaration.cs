...
namespace CSharpAnalyze.Domain.Model.Analyze.Items
{
  public class ItemStatementLocalDeclaration : AbstractItem
  {
    ...
    public ItemStatementLocalDeclaration(LocalDeclarationStatementSyntax node, SemanticModel semanticModel)
    {
      ...
      var opration = semanticModel.GetOperation(node);
      var desc = Microsoft.CodeAnalysis.Operations.OperationExtensions.Descendants(opration);
